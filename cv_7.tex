...
\cvitem{Completa}{C\#}
\cvitem{Avanzata}{C\textbackslash C++, Java}
...
\cvitem{Sufficiente}{OpenGL, Boost C++, DirectX, HLSL, GLSL, Twitter4j, SQL, Linguaggi funzionali, Programmazione Assembly di architetture MIPS R2000/R3000, Android SDK, Cisco IOS}
...
\includepdf[pages=-]{aiv1.pdf}
\includepdf[pages=-]{aiv2.pdf}
\includepdf[pages=-]{voto_triennale.pdf}
\includepdf[pages=-]{voto_magistrale.pdf}
