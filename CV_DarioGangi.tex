...
\cventry{07/2017--OGGI}{Programmatore}{Milestone s.r.l. (Koch Media - Embracer Group)}{Milano}{}
{
	\begin{itemize}
		\item Sviluppo videogiochi:
		\begin{itemize}
			\item Monster Energy Supercross The Official Videogame 3
			\item MXGP 2019
			\item Monster Energy Supercross The Official Videogame 2
			\item MXGP Pro
			\item Monster Energy Supercross The Official Videogame 
		\end{itemize}
		\item Collaborazione sviluppo videogiochi:
		\begin{itemize}
			\item MotoGP 20
			\item Ride 4
			\item MotoGP 19
			...
			\item Gravel
		\end{itemize}
		\item Linguaggi utilizzati: C++, Blueprint (linguaggio di scripting visuale per Unreal Engine 4), SQL 
		\item Strumenti utilizzati: Microsoft Visual Studio, Unreal Engine 4, Perforce Helix Core, SQLiteStudio
	\end{itemize}
}
...
\cvitem{Completa}{C\textbackslash C++, C\#, Unreal Engine 4, Microsoft Visual Studio}
\cvitem{Avanzata}{Java, SQL, Perforce Helix Core}
...
\cvlistdoubleitem{Networking}{Elettronica}
