...
\\
\textbf{Indirizzo}: \hspace{4mm} Via Donizetti, 8 - 27058 Voghera (PV)
\\
...
\cvitem{Buone\textbackslash Ottime}{Unity 3D, OpenCV, Microsoft .Net, Microsoft Visual Studio, XNA, Windows Phone SDK, NetBeans, Eclipse, \LaTeX, JSP, HTML, Javascript, jQuery, Google Charts}
