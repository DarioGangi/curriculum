...
\cventry{02/2017--OGGI}{Programmatore}{EUCENTRE (European Centre for Training and Research in Earthquake Engineering)}{Pavia}{}
{
	\begin{itemize}
		...
		\item Strumenti utilizzati: Apache Tomcat, Eclipse, NetBeans, Notepad++, SVN, PostgreSQL, Wordpress, phpMyAdmin, MySQL
	\end{itemize}
}
...
\cvitem{Buone\textbackslash Ottime}{Unity 3D, OpenCV, Microsoft .Net, Microsoft Visual Studio, XNA, Windows Phone SDK, NetBeans, Eclipse, \LaTeX, JSP, HTML, Javascript}
\cvitem{Sufficiente}{OpenGL, Boost C++, DirectX, HLSL, GLSL, Unreal Engine 4, Twitter4j, SQL, Linguaggi funzionali, Programmazione Assembly di architetture MIPS R2000/R3000, Android SDK, Cisco IOS, Amazon Web Services, Hadoop, PHP, Wordpress, phpMyAdmin, MySQL}
