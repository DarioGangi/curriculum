...
\address{}{27058 - Voghera (PV) - Italia}
...
\photo[120pt][0.4pt]{pictures/foto} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\\
\textbf{Residenza}: \hspace{1.5mm} Voghera (PV)
\\
\textbf{Cellulare}: \hspace{4mm} (+39) 333 65 67 094
\\
\textbf{Email}: \hspace{9.5mm} dariogangi@hotmail.com
\\
...
\cventry{11/2023-OGGI}{Game Design e Game Programmer}{Self Employed}{Voghera}{}
{
	\begin{itemize}
		\item Sviluppo (programmazione e game design) del videogioco \textbf{Faroda}:
		\begin{itemize}
			\item \url{https://store.steampowered.com/app/3585880/Faroda/}
		\end{itemize}
		\item Linguaggi utilizzati: C++, Blueprint
		\item Strumenti utilizzati: Unreal Engine 5, Microsoft Visual Studio, Perforce Helix Core, Tiled, paint.net, DaVinci Resolve, Confluence, Trello
		\item Piattaforme: Windows (Steam, Epic Game Store)
	\end{itemize}
}

\cventry{07/2017-11/2023}{Programmatore}{Milestone s.r.l. (Plaion - Embracer Group)}{Milano}{}
{
	\begin{itemize}
		\item Sviluppo videogiochi:
		\begin{itemize}
			\item Monster Energy Supercross The Official Videogame 3 (Game Logics \& UI Programmers)
			\item MXGP 2019 (Game Programmers)
			\item Monster Energy Supercross The Official Videogame 2 (Game Logics \& UI Programmers)
			\item MXGP Pro (Game Logics \& UI Programmers)
			\item Monster Energy Supercross The Official Videogame (Game Programmers)
			\item Hot Wheels: Unleashed (Game Programmers)
			\item Hot Wheels: Unleashed 2 - Turbocharged (Gameplay Programmer)
		\end{itemize}
		\item Linguaggi utilizzati: C++, Blueprint, SQL 
		\item Strumenti utilizzati: Microsoft Visual Studio, Unreal Engine 4, Unreal Engine 5, Perforce Helix Core, SQLiteStudio, Jira, Confluence, Swarm, Jenkins
		\item Piattaforme: Windows (Steam, Microsoft Game Store, Epic Game Store), Linux (versioni server), Xbox One, PS4, Nintendo Switch, Xbox Series S/X, PS5, Google Stadia.
	\end{itemize}
}

\cventry{02/2017--07/2017}{Programmatore}{EUCENTRE (European Centre for Training and Research in Earthquake Engineering)}{Pavia}{}
{
	\begin{itemize}
...
\cventry{11/2008--01/2011}{Programmatore}{AIV c\textbackslash o Elemental srl}{Viale Ippocrate, 73, 00161 - Roma (Italia)}{}
{
...
\cvitem{Completa}{C\textbackslash C++, C\#, Unreal Engine 4 \& 5, Microsoft Visual Studio, Blueprint}
\cvitem{Avanzata}{Java, SQL, Perforce Helix Core, Jira, Confluence, Swarm, Jenkins}
\cvitem{Buone\textbackslash Ottime}{Unity 3D, OpenCV, Microsoft .Net, XNA, Windows Phone SDK, NetBeans, Eclipse, \LaTeX, JSP, HTML, Javascript, jQuery, Google Charts}
\cvitem{Sufficiente}{OpenGL, Boost C++, DirectX, HLSL, GLSL, Twitter4j, SQL, Linguaggi funzionali, Programmazione Assembly di architetture MIPS R2000/R3000, Android SDK, CiscoIOS, Amazon Web Services, Hadoop, PHP, Wordpress, phpMyAdmin, MySQL, Konckout.js}
...
\cvlistdoubleitem{Retrogaming}{Game Design}
\cvlistdoubleitem{Informatica}{Elettronica}
\cvlistdoubleitem{Fumetti}{Cinema}
